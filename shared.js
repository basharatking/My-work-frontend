...
const NAV_DROPS = {
  ...
  merge: {
    ...
    icon: "📎",
    tools: [
      ["merge-pdf.html","📎","Merge PDF","Combine multiple PDFs"],
      ["split-pdf.html","✂️","Split PDF","Extract or split pages"],
      ["rotate-pdf.html","🔄","Rotate PDF","90°, 180°, 270°"],
      ["delete-pages.html","🗑️","Delete Pages","Remove unwanted pages"],
      ["reorder-pages.html","↕️","Reorder Pages","Drag to rearrange"],
...
function _buildAllTools() {
  const cols = Object.entries(NAV_DROPS).map(([key, d]) => `
